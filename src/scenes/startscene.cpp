...
void StartScene::create() {
  ...
  SpriteConfig* door_config = new AnimationConfig(0.3, 7, 11, 1, false, 0);
  static_cast<AnimationSprite*>(sprites["door"])->create(windowPointer, 120, 50, 0, 0, 318, 540, sf::Vector3f(0, 0, 0), "door.png", "", "", door_config);
