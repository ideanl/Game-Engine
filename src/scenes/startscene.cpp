...
void StartScene::create() {
  ...
  //SpriteConfig* main_character_config = new AnimationConfig(0.3, 10, 4, 3, 719, 450, false, 6);
  //static_cast<AnimationSprite*>(sprites["main_character"])->create(windowPointer, 0, 0, 0, 0, 0, 0, sf::Vector3f(0, 0, 0), "main_character.png", "", "", main_character_config);
